...
<!-- MPU Bottom ad head script -->
	<?php if ( get_field( 'mpu_bottom_slot_head_script', 'options' )) : ?>
...
<!-- Homepage top ad head script-->
	<?php if ( get_field( 'header_ad_top_slot_head', 'options' )) : ?>
...
<!-- Homepage middle ad head script -->
	<?php if ( get_field( 'header_ad_middle_slot_head', 'options' )) : ?>
...
<!-- Homepage bottom ad head script -->
	<?php if ( get_field( 'header_ad_bottom_slot_head', 'options' )) : ?>
